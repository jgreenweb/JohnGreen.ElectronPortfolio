...
export default {
  ...
  data() {
    return {
      myFace:
        "https://media-exp1.licdn.com/dms/image/C4D03AQG8srAfhWbhhg/profile-displayphoto-shrink_800_800/0/1605154329795?e=1623888000&v=beta&t=Igj-4KwBvZuH5k1DRf48IWZJ-h-W7zW1DIFnzocmC_E",
    };
  },
  methods: {
    getProps() {
